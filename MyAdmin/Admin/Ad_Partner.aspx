    ...
    <table class="Data" border="0" cellpadding="0" cellspacing="0">
        <tbody>
            <tr class="Table_Header">
                ...
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_1" CommandArgument="PartnerID ASC" OnClick="lbtn_Sort_Click">Mã</asp:LinkButton></th>
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_2" CommandArgument="PartnerName ASC" OnClick="lbtn_Sort_Click">Tên đối tác</asp:LinkButton></th>
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_3" CommandArgument="PartnerTypeName ASC" OnClick="lbtn_Sort_Click">Nhóm đối tác</asp:LinkButton></th>
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_4" CommandArgument="Phone ASC" OnClick="lbtn_Sort_Click">Điện thoại</asp:LinkButton></th>
                <th>Email</th>
                 <th>
