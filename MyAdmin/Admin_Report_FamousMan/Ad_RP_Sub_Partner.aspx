<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_RP_Sub_Partner.aspx.cs" Inherits="MyAdmin.Admin_Report_FamousMan.Ad_RP_Sub_Partner" %>
            ...
            <asp:Repeater runat="server" ID="rpt_Data">
                <ItemTemplate>
                    <tr class="Table_Row_1">
                        ...
                        <td><%#((double)Eval("SaleBuyContent")).ToString(MyUtility.MyConfig.IntFormat)%></td>
